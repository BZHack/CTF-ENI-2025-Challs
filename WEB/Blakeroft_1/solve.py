    ...
    def process(self):
        while True:
            ...
            try:
                ...
                try:
                    # Disable SSL verification for invalid certificates
                ...
                # Save content only if response is 200
                if response.status_code == 200:
                    ...
                    # Process .DS_Store files to extract additional URLs
...
if __name__ == '__main__':
    if len(sys.argv) == 1:
        ...
        sys.exit(0)
    requests.packages.urllib3.disable_warnings()  # Suppress SSL warning messages
